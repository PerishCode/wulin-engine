...
terrain-body 槽；但尚无 live wall-clock driver、多 actor store、水平速度或 locomotion controller。
...
bounded retained batch execution with partition equality and mid-batch rollback,
explicit elapsed schedule/body dual commit with coarse/nominal partition equality,
